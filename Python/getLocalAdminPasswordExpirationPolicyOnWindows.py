...
def getLocalAdminExpirationPolicy(): 
    ...
    try:
        ...
        print("Started getting local admin password expiration policy at", startDateTime.strftime("%Y-%m-%d %H:%M %p"))
        ...
        print("Finshed getting local admin password expiration policy at", finishedDateTime.strftime("%Y-%m-%d %H:%M %p"))
