...
def checkSteamLocomotive(): 
    ...
    try:
        ...
        print("Started checking Steam Locomotive at", startDateTime.strftime("%Y-%m-%d %H:%M %p"))
        ...
        if operatingSystem == "macOS" or operatingSystem == "Linux":
            ...
            if checkSteamLocomotiveOnMacOrLinux == 0:
                ...
                print("Finished checking Steam Locomotive at", finishedDateTime.strftime("%Y-%m-%d %H:%M %p"))
